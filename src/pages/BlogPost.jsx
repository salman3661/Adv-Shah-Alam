            ...
            <div className="msb-bar">
                <div className="msb-left">
                    ...
                    <div className="msb-identity">
                        ...
                        <span className="msb-sub">Bangladesh Supreme Court · Available Now</span>
                    </div>
                </div>
                <div className="msb-right">
                    ...
                    <a href={`https://wa.me/8801712655546?text=${encodeURIComponent(`I read: ${post.title}. Need legal help.`)}`} target="_blank" rel="noopener noreferrer" className="msb-btn msb-wa">
