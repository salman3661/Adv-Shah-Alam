...
const pillsBn = [
  { label: '১০+ বছরের অভিজ্ঞতা',   anim: 'pill-float-0', dur: '3.2s', dot: 'dot-glow-blue',  dotColor: '#1A3FBF' },
  { label: 'সুপ্রিম কোর্টের আইনজীবী', anim: 'pill-float-1', dur: '2.8s', dot: 'dot-glow-gold',  dotColor: '#C6A75E' },
...
const Hero = ({ lang = 'en' }) => {
  const isBn = lang === 'bn';
  const heroContent = isBn ? heroBn : heroEn;
  const pills = isBn ? pillsBn : pillsEn;
            ...
            <div className="order-2 md:order-1">
              ...
              <motion.div {...fade(0.2)} style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', marginBottom: '1.5rem' }}>
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontSize: '0.59rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.12em', color: 'var(--hero-label)', marginBottom: '0.22rem' }}>
                ...
                {/* Card 2 — Designation (Public Prosecutor) */}
                <div style={{
                  display: 'flex', alignItems: 'center', gap: '0.85rem',
                  padding: '0.75rem 1rem', borderRadius: '1rem',
                  background: 'var(--hero-cred-bg)',
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--hero-heading)', display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.35rem' }}>
                      {isBn ? 'অ্যাসিস্ট্যান্ট পাবলিক প্রসিকিউটর,' : 'Asst. Public Prosecutor,'}
                      <span style={{
                        display: 'inline-block',
                        ...
                        {isBn ? 'অতিরিক্ত মহানগর দায়রা জজ আদালত-১৪, ঢাকা' : 'Addl. Metro Sessions Court-14, Dhaka'}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '0.86rem', fontWeight: 700, color: 'var(--hero-heading)' }}>
                    <span style={{ fontSize: '0.59rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.12em', color: 'var(--hero-label)', display: 'block', marginBottom: '0.18rem' }}>
                      {isBn ? 'চেম্বার' : 'Chamber'}
                    </span>
