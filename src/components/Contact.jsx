...
const Contact = () => {
    ...
    const contactInfo = [
        { icon: Phone, label: 'Phone / WhatsApp', value: '+880 1955-802007', href: 'tel:+8801955802007' },
    ...
    return (
        <>
            <Helmet>
                <title>Contact | Advocate Md. Shah Alam – Lawyer in Uttara, Dhaka</title>
                <meta name="description" content="Contact Advocate Md. Shah Alam – experienced lawyer in Uttara, Dhaka. Call, WhatsApp, or visit our Sector 12 Uttara office." />
            </Helmet>
